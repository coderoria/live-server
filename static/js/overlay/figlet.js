...
var figlet =
                        ...
                        if (opts.fittingRules.hLayout === FITTING) {
                            ...
                            nextCh =
                                !nextCh && opts.fittingRules.hRule6
                                    ...
                                    : nextCh;
                            nextCh =
                                nextCh || uni_Smush(ch1, ch2, opts.hardBlank);
                            piece2 += nextCh;
                        }
                    } else {
                        piece2 += uni_Smush(ch1, ch2, opts.hardBlank);
     ...
     */
         ...
         */
            if (typeof options.horizontalLayout !== "undefined") {
                params = getHorizontalFittingRules(
            ...
            if (typeof options.verticalLayout !== "undefined") {
                params = getVerticalFittingRules(
    ...
    */
        ...
        */
            ...
            if (
                lines.length <
                opts.numCommentLines + opts.height * charNums.length
            ) {
                ...
                for (ii = 0; ii < opts.height; ii++) {
                    if (typeof figFont[cNum][ii] === "undefined") {
                        ...
                        endCharRegEx = new RegExp(
                            "\\" +
                                figFont[cNum][ii].substr(
                                    figFont[cNum][ii].length - 1,
                                    1
                                ) +
                                "+$"
                        );
                        figFont[cNum][ii] = figFont[cNum][ii].replace(
                            endCharRegEx,
                            ""
                        );
                    }
